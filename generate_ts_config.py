...
IGNORE = ['WAVAX', 'WMATIC', 'WFTM', 'WBNB', 'WETH', 'WHT', 'WxDAI', 'WFUSE', 'WKCS', 'WARETH', 'WONE', 'WOKT', 'WIOTX', 'WHOO', 'WELA', 'WMOVR', 'WTLOS', 'WCRO', 'WKAVA', 'WBTT', 'WAA', 'WASTAR', 'WBRISE', 'WMETIS', 'WNEON', 'WQ', 'WWAN', 'WVLX', 'WRBTC', 'WCLV', 'CELO', 'WGLMR', 'WMNT', 'WBOBA']
